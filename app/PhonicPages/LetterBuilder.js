// app/PhonicPages/LetterBuilder.js
...
export default function PhonicsSoundTrain({ onBack }) {
  ...
  const playLetterSound = async (letter) => {
    try {
      ...
      if (soundFile) {
        ...
        Speech.speak(letter, { language: 'en', pitch: 1.2, rate: 0.8 });
      }
    } catch (error) {
  ...
  const playWordSound = () => {
    ...
    Speech.stop();
    Speech.speak(selectedWord, { language: 'en', pitch: 1.0, rate: 0.9 });
  };

  const selectWord = (word) => {
    setSelectedWord(word);
    Speech.stop();
    Speech.speak(word, { language: 'en', pitch: 1.0, rate: 0.9 });
  };
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 16, color: 'white', marginTop: 5, opacity: 0.9 },
  phaseContainer: { padding: 15, backgroundColor: '#dbeafe' },
  phaseTitle: { fontSize: 18, fontWeight: 'bold', color: '#1e40af', marginBottom: 10, textAlign: 'center' },
  phaseButtons: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' },
  phaseButton: { paddingVertical: 8, paddingHorizontal: 15, backgroundColor: '#eff6ff', borderRadius: 15, margin: 5, borderWidth: 1, borderColor: '#93c5fd' },
  activePhaseButton: { backgroundColor: '#3b82f6', borderColor: '#1d4ed8' },
  phaseButtonText: { color: '#3b82f6', fontWeight: '600', fontSize: 12 },
  activePhaseButtonText: { color: 'white' },
  mainContent: { alignItems: 'center', padding: 20, minHeight: 250 },
  placeholderContainer: { alignItems: 'center', justifyContent: 'center', padding: 40 },
  placeholderText: { fontSize: 18, color: '#94a3b8', textAlign: 'center', marginTop: 15, fontWeight: '500' },
  wordContainer: { alignItems: 'center', marginBottom: 30, width: '100%' },
  wordTitle: { fontSize: 20, fontWeight: 'bold', color: '#0369a1', marginBottom: 15 },
  lettersContainer: { flexDirection: 'row', justifyContent: 'center', marginBottom: 20, flexWrap: 'wrap' },
  letterButton: { width: 60, height: 60, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fef08a', borderRadius: 12, borderWidth: 2, borderColor: '#f59e0b', margin: 5 },
  letterText: { fontSize: 28, fontWeight: 'bold', color: '#b45309' },
  wordDisplay: { fontSize: 32, fontWeight: 'bold', color: '#0369a1', marginTop: 10, marginBottom: 20 },
  blendButton: { backgroundColor: '#f97316', paddingVertical: 15, paddingHorizontal: 25, borderRadius: 25, flexDirection: 'row', alignItems: 'center' },
  blendButtonText: { color: 'white', fontSize: 18, fontWeight: 'bold', marginLeft: 10 },
  wordsContainer: { padding: 20, backgroundColor: '#e0f2fe', borderTopLeftRadius: 20, borderTopRightRadius: 20 },
  wordsTitle: { fontSize: 22, fontWeight: 'bold', color: '#0369a1', marginBottom: 20, textAlign: 'center' },
  letterCategory: { marginBottom: 25 },
  letterHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 15 },
  letterSoundButton: { backgroundColor: '#bae6fd', paddingVertical: 8, paddingHorizontal: 15, borderRadius: 20, marginRight: 10 },
  letterTitle: { fontSize: 20, fontWeight: 'bold', color: '#0369a1' },
  letterLine: { flex: 1, height: 1, backgroundColor: '#bae6fd' },
  wordList: { flexDirection: 'row', flexWrap: 'wrap' },
  wordButton: { paddingVertical: 10, paddingHorizontal: 18, backgroundColor: '#f0f9ff', borderRadius: 20, marginRight: 12, marginBottom: 12, borderWidth: 1.5, borderColor: '#0ea5e9' },
  selectedWordButton: { backgroundColor: '#0ea5e9' },
  wordButtonText: { color: '#0ea5e9', fontWeight: '600' },
  selectedWordButtonText: { color: 'white' }
});